...
const Hero = () => {
  return (
    <section className="h-screen w-full -z-0 overflow-hidden">
        ...
        {/* Video Camera Icon */}
        <div className='absolute top-1/4 left-10 md:left-20 animate-float z-40'>
        ...
        {/* Play Button Icon */}
        <div className='absolute top-1/3 right-16 md:right-24 animate-float-delayed z-40'>
        ...
        {/* Users/Viewers Icon */}
        <div className='absolute bottom-1/3 left-16 md:left-24 animate-float-slow z-40'>
        ...
        {/* Creator/Edit Icon */}
        <div className='absolute top-1/2 right-8 md:right-16 animate-float z-40'>
        ...
        {/* Microphone Icon */}
        <div className='absolute bottom-1/4 right-12 md:right-20 animate-float-delayed z-40'>
        ...
        {/* Heart/Like Icon */}
        <div className='absolute top-2/3 left-8 md:left-12 animate-float-slow z-40'>
        ...
        {/* Share Icon */}
        <div className='absolute top-1/6 right-1/4 animate-float z-40'>
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className='text-white/35 drop-shadow-lg'>
        ...
        {/* Comment Icon */}
        <div className='absolute bottom-1/6 left-1/4 animate-float-delayed z-40'>
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" className='text-white/40 drop-shadow-lg'>
        ...
        {/* Follow/Plus Icon */}
        <div className='absolute top-1/2 left-1/6 animate-float-slow z-40'>
        ...
        <div className='absolute bottom-1/2 right-1/6 animate-float z-40'>
        ...
        {/* Star/Rating Icon */}
        <div className='absolute top-3/4 right-1/3 animate-float-delayed z-40'>
        ...
        {/* Message/Chat Icon */}
        <div className='absolute top-1/5 left-1/3 animate-float-slow z-40'>
